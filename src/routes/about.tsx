      ...
      <div class="max-w-3xl mx-auto px-6">
        ...
        <div class="rounded-2xl border border-zinc-200/70 dark:border-white/[0.06] bg-zinc-100/60 dark:bg-white/[0.02] p-8 text-center">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="/docs/getting-started/introduction" class="px-6 py-2.5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white text-[14px] font-medium transition-colors">
              Read the Docs
            </a>
          </div>
        </div>
