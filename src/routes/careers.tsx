  ...
  return (
    <div class="py-24 sm:py-32">
      <div class="max-w-3xl mx-auto px-6">
          ...
          {openings.length > 0 ? (
            <div class="space-y-4">
              {openings.map((job) => (
                <a
                  ...
                  class="block group p-6 rounded-xl border border-white/[0.06] bg-white/[0.02] hover:border-white/20 hover:bg-white/[0.03] transition-all"
                >
                  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3">
                    <h3 class="text-white font-medium text-[16px] group-hover:text-white transition-colors">
                      {job.title}
                    </h3>
                    <div class="flex flex-wrap items-center gap-2">
                      <span class="px-2.5 py-1 bg-white/[0.06] text-zinc-400 text-[11px] font-medium uppercase tracking-wider rounded-full">
                        {job.department}
                      </span>
            ...
            <div class="p-8 rounded-xl border border-white/[0.06] bg-white/[0.02] text-center">
              ...
              <p class="text-zinc-500 text-[14px]">
                ...
                <a href="mailto:contact@teploy.com" class="text-white hover:text-zinc-300 underline underline-offset-2 transition-colors">
                  contact@teploy.com
                </a>
              </p>
            </div>
        ...
        {/* How we work */}
        <div class="mb-16">
          <h2 class="text-xl font-semibold text-white mb-6">How we work</h2>
        ...
        <div class="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center">
          <h2 class="text-xl font-semibold text-white mb-3">Want to talk anyway?</h2>
