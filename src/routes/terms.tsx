  ...
  return (
    <div class="py-24 sm:py-32">
      <div class="max-w-3xl mx-auto px-6">
        {/* Header */}
        <div class="mb-16">
          <p class="text-zinc-500 text-[13px] font-medium uppercase tracking-wider mb-4">Legal</p>
        ...
        <div class="prose prose-invert prose-zinc max-w-none">
          <div class="space-y-12">
            ...
            {/* Agreement */}
            <section>
              <h2 class="text-xl font-semibold text-white mb-4">Agreement</h2>
            ...
            {/* The tools */}
            <section>
              <h2 class="text-xl font-semibold text-white mb-4">The tools</h2>
              <p class="text-zinc-400 text-[15px] leading-relaxed mb-4">
              ...
              <ul class="text-zinc-400 text-[15px] leading-relaxed space-y-2 list-disc list-inside">
                <li><strong class="text-zinc-300">teploy CLI</strong> — zero-downtime Docker deploys via SSH</li>
                <li><strong class="text-zinc-300">teploy Dash</strong> — web UI and uptime monitoring for the CLI</li>
                <li><strong class="text-zinc-300">teploy Observe</strong> — self-hosted analytics, APM, and error tracking</li>
                <li><strong class="text-zinc-300">trmnl</strong> — a terminal IDE configuration bundle</li>
              </ul>
            ...
            {/* No warranty */}
            <section>
              <h2 class="text-xl font-semibold text-white mb-4">No warranty</h2>
              <p class="text-zinc-400 text-[15px] leading-relaxed">
            ...
            <section>
              <h2 class="text-xl font-semibold text-white mb-4">Acceptable use of this website</h2>
              <p class="text-zinc-400 text-[15px] leading-relaxed mb-4">
            ...
            <section>
              ...
              <ul class="text-zinc-400 text-[15px] leading-relaxed space-y-2">
                <li>Email: <a href="mailto:contact@teploy.com" class="text-zinc-300 hover:text-white underline underline-offset-2 transition-colors">contact@teploy.com</a></li>
                <li>Support: <a href="/support" class="text-zinc-300 hover:text-white underline underline-offset-2 transition-colors">teploy.com/support</a></li>
              </ul>
            </section>
