  ...
  return (
    <div class="py-24 sm:py-32">
      <div class="max-w-3xl mx-auto px-6">
        {/* Header */}
        <div class="mb-16">
          <p class="text-zinc-600 dark:text-zinc-500 text-[13px] font-medium uppercase tracking-wider mb-4">Security</p>
        ...
        <div class="grid sm:grid-cols-2 gap-4 mb-16">
          <div class="p-5 rounded-xl border border-zinc-200/70 dark:border-white/[0.06] bg-zinc-100/60 dark:bg-white/[0.02]">
            ...
            <p class="text-zinc-600 dark:text-zinc-500 text-[14px]">MIT / AGPL on GitHub — read the code, build it yourself.</p>
          </div>
          <div class="p-5 rounded-xl border border-zinc-200/70 dark:border-white/[0.06] bg-zinc-100/60 dark:bg-white/[0.02]">
            <h3 class="text-zinc-900 dark:text-white font-medium text-[15px] mb-1">No telemetry</h3>
            <p class="text-zinc-600 dark:text-zinc-500 text-[14px]">Binaries don't ping a Teploy server. Ever.</p>
          </div>
          <div class="p-5 rounded-xl border border-zinc-200/70 dark:border-white/[0.06] bg-zinc-100/60 dark:bg-white/[0.02]">
            <h3 class="text-zinc-900 dark:text-white font-medium text-[15px] mb-1">Local credentials</h3>
            <p class="text-zinc-600 dark:text-zinc-500 text-[14px]">SSH keys, registry tokens, env vars — all stay on your machine.</p>
          </div>
          <div class="p-5 rounded-xl border border-zinc-200/70 dark:border-white/[0.06] bg-zinc-100/60 dark:bg-white/[0.02]">
            <h3 class="text-zinc-900 dark:text-white font-medium text-[15px] mb-1">Reproducible builds</h3>
            <p class="text-zinc-600 dark:text-zinc-500 text-[14px]">GitHub Actions builds the releases. SHA256 published with every tag.</p>
          </div>
        </div>
